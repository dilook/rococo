...
insert into "country" (name) values ('КНДР');
...
insert into "country" (name) values ('ДР Конго');
...
insert into "country" (name) values ('Мальдивские Острова');
...
insert into "country" (name) values ('Республика Македония');
...
insert into "country" (name) values ('Туркмения');
...
insert into "country" (name) values ('ЦАР');
